...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/sbin/git" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "/sbin/git" show-ref "master"
  WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "/sbin/git" fetch --tags --force "origin"
    WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "/sbin/git" symbolic-ref -q HEAD
    WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "/sbin/git" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
...
execute_process(
  COMMAND "/sbin/git" status --porcelain
  WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "/sbin/git" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "/sbin/git" checkout "${checkout_name}"
    WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "/sbin/git" rebase "${checkout_name}"
    WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "/sbin/git" stash pop --index --quiet
          WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: '/home/dan/Geopol/_deps/ftxui-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "/sbin/git" reset --hard --quiet
      WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
    )
    execute_process(
      COMMAND "/sbin/git" stash pop --quiet
      WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "/sbin/git" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
      )
      execute_process(
        COMMAND "/sbin/git" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/dan/Geopol/_deps/ftxui-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "/sbin/git" submodule update --recursive --init 
    WORKING_DIRECTORY "/home/dan/Geopol/_deps/ftxui-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
